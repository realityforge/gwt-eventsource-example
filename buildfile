...
desc 'A simple application demonstrating the use of the gwt-eventsource library'
define 'gwt-eventsource-example' do
  ...
  compile.with :gwt_eventsource, :javax_annotation, :javax_javaee, :gwt_user
  ...
  iml.add_gwt_facet({'org.realityforge.gwt.eventsource.example.Example' => true},
